module Plutus
  ...
  class Account < ActiveRecord::Base
    ...
    belongs_to :owner, :class_name => "Plutus::Account", foreign_key: 'tenant_id', :optional => true
    ...
    def self.types_human_readable
      {
          'Plutus::Asset' => 'Asset',
          'Plutus::Equity' => 'Equity',
          'Plutus::Expense' => 'Expense',
          'Plutus::Liability' => 'Liability',
          'Plutus::Revenue' => 'Revenue',
          'Plutus::Bank' => 'Bank',
      }
    end
